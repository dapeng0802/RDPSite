...
DATABASES = {
    'default': {
        ...
        'NAME': 'rdpsite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '(^1l(2+0kjm-@rn)xym5&(nfgek20h^z4+o4*xuf!+*ol^p^l!'
...
ROOT_URLCONF = 'RDPSite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'RDPSite.wsgi.application'
